...
const Address = () => {
  ...
  return (
    <>
    <h3 className='text-center mt-5'> Login DETAILS Verify.if yes then display user name</h3>
    <div className="cart-page mt-5">
   
      <div className="delivery-info">
        <p>Deliver to: <strong>Jignesh, 382350</strong></p>
        <p>D/96, sunrise park, Ahmedabad,Gujrat</p>
      ...
      <button className="place-order-button w-25">Continue</button>
    </div>
